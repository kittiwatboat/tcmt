    ...
    <body class="py-5">
        ...
        <div id="superlarge-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">ADD Receipt</h2>
                        </div>
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            ...
                            <br>
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-4" class="form-label">ชื่อผู้รับ</label>
                                <select class="tom-select w-full" type="text" id="Detail_refer" name="Detail_refer" onchange="selectitem()">
                                    <option>เลือกผู้รับ</option>
                                    <option>ผู้รับ1</option>
                                    <option>ผู้รับ2<option>
                                </select>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-3" class="form-label">ได้รับเงินค่า</label>
                                <input id="modal-form-3" name="firstname" type="text" class="form-control" placeholder="" value="{{old('firstname')}}" required>
                            </div>
                            {{-- <br> --}}
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-4" class="form-label">จำนวนเงิน</label>
                                <input id="modal-form-4" name="lastname" type="text" class="form-control" placeholder="" value="{{old('lastname')}}" required>
                            </div>
                            {{-- <br> --}}
                            <div class="col-span-12 sm:col-span-6">
                            ...
                            {{-- <br> --}}
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-3" class="form-label">จำนวนเงินสุทธิ</label>
                                <input id="modal-form-3" name="firstname" type="text" class="form-control" placeholder="จำนวนเงินสุทธิ" value="{{old('firstname')}}" required>
                            </div>
                        </div>
