                ...
                <div class="top-bar">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">ตั้งค่าข้อมูลคำนำหน้าชื่อ</li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    <th class="whitespace-nowrap">คำนำหน้าชื่อ</th>
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            ...
                            <div class="intro-y col-span-12">
                                ...
                                <div class="grid grid-cols-12 gap-2">
                                    <select class="form-select sm:mr-2 col-span-4" placeholder="คำนำหน้าชื่อ" aria-label="Default select example"> 
                                    ...
                                    <input type="text" id="name" name="name" class="form-control col-span-4" placeholder="ชื่อพนักงาน" aria-label="default input inline 2"> 
                                    <input type="text" id="lastname" name="lastname" class="form-control col-span-4" placeholder="นามสกุลพนักงาน" aria-label="default input inline 3"> 
                                </div> 
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <input class="form-control" type="text" id="companyaddressthai" name="companyaddressthai" placeholder="ที่อยู่พนักงาน" value="{{old('companyaddressthai')}}" >
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-1" class="form-label">รหัสพนักงาน</label>
                                <input id="modal-form-1" name="employeeID" type="text" class="form-control" placeholder="รหัสพนักงาน" value="{{old('employeeID')}}" required>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                <input id="modal-form-3" name="bank" type="text" class="form-control" placeholder="ธนาคาร" value="{{old('bank')}}" required>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <label for="modal-form-4" class="form-label">เลขบัญชีธนาคาร</label>
                                <input id="modal-form-4" name="banknumber" type="text" class="form-control" placeholder="เลขบัญชีธนาคาร" value="{{old('banknumber')}}" required>
                            </div>
